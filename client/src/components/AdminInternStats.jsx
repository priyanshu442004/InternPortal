...
const AdminInternStats = () => {
  ...
  return (
    <div className="grid grid-cols-4 w-max gap-2">
      <div className="bg-[#b8c0e3] w-[120px] h-[170px] p-2 rounded-lg text-center">
      ...
      <div className="bg-[#F6A997] w-[120px] h-[170px] p-2 rounded-lg text-center">
            <div className='flex-col flex'>
      ...
      <div className="bg-[#FCE0BB] w-[120px] h-[170px] p-2 rounded-lg text-center">
            <div className='flex-col flex'>
                <h1 className='text-[13px] px-1 text-left font-mukta font-bold'>In-Active Interns<br /> {inactiveInterns} </h1>
                <img src={graph23} height={98} width={102} className="mt-2" alt=""/>
            </div>
      </div>
      <div className="bg-blue-200 w-[120px] h-[170px] p-2 rounded-lg text-center">
            <div className='flex-col flex'>
