...
const AddminAddIntern = () => {
  ...
  return (
    <div className="w-full px-4 py-6 bg-slate-50 flex justify-center items-center flex-col md:px-8 lg:px-12">
      <div className="flex justify-between items-center mb-6 w-full bg-white p-2 rounded-lg shadow-sm md:w-[90%] lg:w-[80%] xl:w-[70%]">
      ...
      <form
        className="space-y-6 bg-white rounded-lg p-6 shadow-sm w-full md:w-[90%] lg:w-[80%] xl:w-[70%]"
